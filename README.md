...
2) generates **2 portfolio project plans** (architecture + 7-day sprint plan) that help you *prove* those missing keywords for your target role.
...
### Goals
- Input: `resume_text`, `jd_text` (paste)
- Output:
